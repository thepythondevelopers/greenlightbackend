...
const UserSchema:any = createSchema({
   ...
   ethinicity_other:Type.string({default:null}),
   politics_other:Type.string({default:null}),
   looking_other:Type.string({default:null}),
   ...
   have_car:Type.string({ default: null }),
    work_position:Type.string({default:null}),
    work_employer:Type.string({default:null}),
